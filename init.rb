require 'redmine'
require 'holidays'
require 'holidays/ch'       # Edit this to the most appropriate holiday region for you: http://code.dunae.ca/svn/holidays/trunk/data/
$holiday_locale = 'ch_sg'   # Set this to the same region (or subregion if appropriate)
